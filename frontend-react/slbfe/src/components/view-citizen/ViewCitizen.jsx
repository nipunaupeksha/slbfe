...
class ViewCitizen extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div>
        ...
        <div className="card col-md-6 offset-md-3">
          <h3 className="text-center" style={{color:"#000"}}> View Citizen Details</h3>
          <div className="card-body">
            ...
            <div className="row">
              ...
              <div style={{color:"#000"}}> {this.state.citizen.gender}</div>
            </div>
            <div className="row">
              <label style={{color:"#000"}}> Date of Birth: </label>
              <div style={{color:"#000"}}> {this.state.citizen.dateOfBirth}</div>
            </div>
            <div className="row">
              <label style={{color:"#000"}}> Age: </label>
              <div style={{color:"#000"}}> {this.state.citizen.age}</div>
            </div>
            <div className="row">
              <label style={{color:"#000"}}> Profession: </label>
              <div style={{color:"#000"}}> {this.state.citizen.profession}</div>
            </div>
            <div className="row">
              <label style={{color:"#000"}}> Affiliation: </label>
              <div style={{color:"#000"}}> {this.state.citizen.affiliation}</div>
            </div>
            <div className="row">
            ...
            <div className="row">
             ...
             <div className="row">
              <label style={{color:"#000"}}> Passport: </label>
              <div style={{color:"#000"}}> {this.state.passport.passportId}</div>
            </div>
            <div className="row">
              <label style={{color:"#000"}}> Nic: </label>
              <div style={{color:"#000"}}> {this.state.nic.nicId}</div>
            </div>
            <div className="row">
              <label style={{color:"#000"}}> Birth Certificate: </label>
              <div style={{color:"#000"}}> {this.state.bc.birthCertificateId}</div>
            </div>
            <button
            ...
            <button
                    ...
                    onClick={this.updateCitizen.bind(this)}
                  >Update</button>
          </div>
        </div>
      </div>
